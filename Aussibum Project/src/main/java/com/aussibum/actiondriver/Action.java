 ...
 * Created by Nasar 
 */
package com.aussibum.actiondriver;
import java.io.File;
...
import com.aussibum.actioninterface.ActionInterface;
import com.aussibum.base.BaseClass;


/**
 * @author Nasar added on 7th November 2022
 *
 */
public class Action extends BaseClass implements ActionInterface {
	...
	@Override
	public void scrollBYAxises(WebDriver driver) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,300)","");
	}
	@Override
	public void scrollBYAxises1(WebDriver driver) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,200)","");
	}
	@Override
	public void click(WebDriver driver, WebElement ele) {
		//String status=prop.getProperty("ElementHighlight");
	...
	@Override
	public void normalclick(WebDriver driver, WebElement ele) {
		ele.click();
	}
	
	@Override
	public void enter(WebDriver driver, WebElement ele,String text) {
		System.out.println("send ket text is "+text);
		String replace=text.replaceAll("4209.0", "4209");
		
		ele.sendKeys(replace);
	}
	...
	@Override
	public void switchToFrameByXpath(WebDriver driver,WebElement ele) {
	...
	@Override
	public void type_integer(CharSequence[] num, WebElement ele) {
		// TODO Auto-generated method stub
